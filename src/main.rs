...
#[post("/location/get")]
async fn location_get(info: web::Json<SessionKeyIn>, data: web::Data<AppState>) -> impl Responder {
...
async fn location_update(info: web::Json<LocationIn>, data: web::Data<AppState>) -> impl Responder {
